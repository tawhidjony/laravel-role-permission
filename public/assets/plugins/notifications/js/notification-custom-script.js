...
/* Rounded corners Notifications */
     ...
     /* Notifications With Images*/
         ...
         function img_default_noti(){
            ...
            continueDelayOnInactiveTab: false,
		    position: 'top right',
		    img: 'assets/plugins/notifications/img/1.jpg', //path to images
		    msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
		    });
		  }
        ...
        function img_info_noti(){
            ...
            icon: 'fa fa-info-circle',
		    position: 'top right',
		    img: 'assets/plugins/notifications/img/2.jpg', //path to images
		    msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
		    });
		  }
        ...
        function img_warning_noti(){
            ...
            continueDelayOnInactiveTab: false,
		    position: 'top right',
		    img: 'assets/plugins/notifications/img/3.jpg', //path to images
		    msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
		    });
		  }		 
		  ...
		  function img_error_noti(){
            ...
            icon: 'fa fa-times-circle',
		    position: 'top right',
		    img: 'assets/plugins/notifications/img/4.jpg', //path to images
		    msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
		    });
		  }		 
		  ...
		  function img_success_noti(){
		    ...
		    position: 'top right',
		    icon: 'fa fa-check-circle',
		    img: 'assets/plugins/notifications/img/5.jpg', //path to images
		    msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
		    });
		  }		 
